...
from taskier import Task, TaskierDBOption, TaskierError, TaskStatus, set_db_options
from taskier_app_helper import TaskierFilterKey, TaskierMenuOption
...
def setup_filters():
    ...
    with sidebar.expander("Sort and Filter", expanded=True):
        ...
        filter_params[TaskierFilterKey.SELECTED_STATUSES] = st.multiselect(
